  ...
  return (
    ...
    >
      <div className="xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        <p className="mt-6 text-xl font-montserrat text-coral-red">
          Our Summer collections
        </p>

        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold z-10">
          <span className="xl:bg-tint-peach xl:whitespace-nowrap relative z-10 pr-10">
            The New Arrival
          </span>
          <br />
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-opacity-0 bg-cover bg-center rounded-b-lg">
        <img
          src={bigShoeImg}
          alt="shoe colletion"
          width={610}
